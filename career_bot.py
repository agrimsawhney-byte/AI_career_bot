...
st.caption("Your personal career advisor. Ask anything about jobs, skills and growth")
...
persona_context = {
    "Student": "The user is a student exploring career options. Focus on internships, entry level jobs, skill building, and college-to-career transition",
